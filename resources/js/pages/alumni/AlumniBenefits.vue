        ...
        <div class="row g-5 g-md-0 justify-content-sm-center">
          <div class="col-xl-5 col-lg-6 col-md-6 col-sm-11">
            <div class="left__side">
              <div class="rts__section--wrapper v__7">
                ...
                <p class="rts__section--description">Embark on a journey of knowledge, discovery, and growth at Unipix
                  University. Our admissions process is designed identify bright, motivated individuals who are eager
                  contribute to our dynamic academic community.</p>
              </div>
              <div class="left__side__image">
                ...
                <p class="left__side__description">Through these narratives, readers gain insight into the diverse
                  backgrounds, aspirations, and achievements of individuals.</p>
              </div>
            </div>
          ...
          <div class="col-lg-6 col-md-6 offset-xl-1 col-sm-11">
            <div class="right__side">
              ...
              <p class="right__side__description">Delve into the heartfelt narratives of Unipix students, where each
                story resonates with triumph, resilience, and personal growth. From academic achievements to
                life-changing experiences, these stories illuminate.</p>
