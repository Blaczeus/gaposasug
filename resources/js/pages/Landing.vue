...
import SwiperInit from '@/components/SwiperInit.vue'
                ...
                <div class="navigation">
                  <nav class="navigation__menu">
                    <ul>
                      ...
                      <li class="navigation__menu--item">
                        <a href="/events" class="navigation__menu--item__link">Events</a>
                      </li>
                      <li class="navigation__menu--item">
                        <a href="/blog" class="navigation__menu--item__link">News</a>
                      </li>
                      <li class="navigation__menu--item">
                        <a href="/student-voice" class="navigation__menu--item__link">Student Voice</a>
                      </li>
                      <li class="navigation__menu--item has-child has-arrow">
                        <a href="/alumni" class="navigation__menu--item__link">Alumni</a>
                      ...
                      <li class="navigation__menu--item has-child has-arrow">
                        <a href="javascript:void(0);" class="navigation__menu--item__link">Support</a>
                        <ul class="submenu sub__style">
    ...
    <div id="side-bar" class="side-bar">
      ...
      <div class="inner-main-wrapper-desk">
        ...
        <div class="inner-content">
          <p class="disc">
            A modern HTML template for education, offering intuitive design & essential features for seamless learning
            experiences.
          </p>
          <!-- offcanvase banner -->
      ...
      <div class="mobile-menu-main">
        <nav class="nav-main mainmenu-nav mt--30">
          <ul class="mainmenu metismenu" id="mobile-menu-active">
            <li>
              <a class="mobile-menu-link main" href="/">Home</a>
            </li>
            <li>
              <a class="mobile-menu-link main" href="/about">About</a>
            </li>
            <li>
              <a class="mobile-menu-link main" href="/events">Events</a>
            </li>
            <li>
              <a class="mobile-menu-link main" href="/blogs">News</a>
            </li>
            <li>
              <a class="mobile-menu-link main" href="/student-voice">Student Voice</a>
            </li>
            <li class="has-droupdown">
              <a href="javascript:void(0);" class="main">Alumni</a>
              <ul class="submenu mm-collapse">
                <li><a class="mobile-menu-link" href="/alumni-benefits">Alumni Benefits</a></li>
                <li><a class="mobile-menu-link" href="/graduate-support">Graduate Career Support</a></li>
                <li><a class="mobile-menu-link" href="/networking-events">Events and Networking</a></li>
                <li><a class="mobile-menu-link" href="/recent-graduates">Recent Graduates</a></li>
                <li><a class="mobile-menu-link" href="/mentorship">Mentorship</a></li>
                <li><a class="mobile-menu-link" href="/alumni-account">Alumni Account</a></li>
              </ul>
            </li>
            <li class="has-droupdown">
              <a href="javascript:void(0);" class="main">Support</a>
              <ul class="submenu mm-collapse">
                <li><a class="mobile-menu-link" href="/support/housing">Housing Issue</a></li>
                <li><a class="mobile-menu-link" href="/support/academic">Academic</a></li>
                <li><a class="mobile-menu-link" href="/support/report">Report</a></li>
              </ul>
            </li>
          </ul>
        </nav>
        ...
        <div class="offcanvase__info--content mt--30">
          <a href="callto:+61485826710"><span><i class="fa-sharp fa-light fa-phone"></i></span>+(61) 485-826-710</a>
          <a href="javascript:void(0);"><span><i class="fa-sharp fa-light fa-location-dot"></i></span>Yarra Park, Melbourne, Australia</a>
          <div class="offcanvase__info--content--social">
            <p class="title">Follow Us:</p>
            <div class="social__links">
              <a href="#"><i class="fa-brands fa-facebook"></i></a>
