...
<template>
  <div>
    ...
    <!-- BREADCRUMB AREA -->
    <Breadcrumb :title="post?.title || 'Event Details'" :breadcrumbs="[
      { label: 'Home', route: 'home' },
      { label: 'Events', route: 'events' },
      { label: post?.title || 'Event Details' }
    ]" />
              ...
              <div class="event-details__content">
                ...
                <div class="event-details__content--text">
                  <div class="rts-section">
                    ...
                    <p class="description">Join us for the Future Minds Symposium, a thought-provoking educational event
                      ...
                      various fields to explore cutting-edge ideas and share insights on shaping the future.</p>
                  </div>
                </div>
                <div class="event-details__content--feature">
                  ...
                  <div class="single-feature">
                    ...
                    <p class="feature-description">Connect with like-minded individuals, professionals, and mentors.
                  ...
                  <div class="single-feature">
                    ...
                    <p class="feature-description">Hear from renowned thought leaders who will delve into topics such as
                      artificial intelligence, sustainability, and the future of work. Gain valuable perspectives to
                      help you thrive.</p>
                  </div>
                  <!-- single feature -->
                  <div class="single-feature">
                    ...
                    <p class="feature-description">Hear from renowned thought leaders who will delve into topics such as
                      artificial intelligence, sustainability, and the future of work. Gain valuable perspectives.</p>
                  </div>
                  <!-- single feature -->
                  <div class="single-feature">
                    <p class="feature-heading">Registration:</p>
                    <p class="feature-description">Secure your spot today and be part of the Future Minds Symposium.
        ...
        <div class="row">
          ...
          <div class="col-12">
            <div class="event-location-map">
              <iframe class="event-location-map-iframe"
