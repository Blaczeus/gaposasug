...
<template>
  <div>
    ...
    <!-- BREADCRUMB AREA -->
    <Breadcrumb :title="post?.title || 'Blog Details'" :breadcrumbs="[
      { label: 'Home', route: 'home' },
      { label: 'News', route: 'blog' },
      { label: post?.title || 'Blog Details' }
    ]" />
        ...
        <div class="row sticky-coloum-wrap justify-content-center g-5">
          <div class="col-lg-8 col-md-10">
            <article class="blog-details">
              ...
              <p>Welcome to Unipix! As a student, navigating through college can sometimes feel overwhelming. However,
                with the right strategies and study techniques, you can enhance your learning experience and achieve
                academic success. In this blog post, we'll explore 10 effective study tips to help you thrive in
                college.</p>
              <h5>Create a Study Schedule:</h5>
              <p>Establishing a study schedule can help you manage your time effectively and ensure that you allocate
                sufficient time for studying each subject. Determine your most productive hours and dedicate them to
                focused study sessions.</p>
              <h5>Set Specific Goals:</h5>
              <p>Set clear and achievable goals for each study session. Whether it's completing a set of practice
                problems or reviewing lecture notes, having specific objectives will keep you motivated and on track.
              </p>
              <blockquote class="rts-blockquote">
                <h4>The Unipix Advantage</h4>
                <p>At Unipix, we understand the transformative power of education, and we're committed to making
                  learning accessible, engaging, and impactful for everyone. Here's how Unipix can help you on your
                  education journey:</p>
                <span>Maria Sarapoba</span>
              </blockquote>
              <p>Whether you're looking to advance your career, pursue your passions, or simply expand your horizons,
                Unipix is here to help you unlock your full potential. Embrace the journey of lifelong learning with
                Unipix as your trusted partner and embark on a transformative educational experience that will shape
              ...
              <p>In an era defined by rapid technological advancements and evolving job markets, the importance of
                lifelong learning cannot be overstated. Lifelong learning empowers individuals to adapt to change,
                acquire new knowledge and skills, and remain competitive in today's dynamic workforce. It fosters
                personal and professional development, enriches lives, and opens doors to endless opportunities.</p>
              ...
              <p>At Unipix, we believe that education has the power to change lives, inspire innovation, and create
                positive impact in the world. Join us on this exciting journey of lifelong learning and discover the
                endless possibilities that await you. Visit Unipix today and take the first step towards realizing your
                dreams and aspirations. Remember, your education journey starts here!</p>
            </article>
            <div class="blog-info">
              <div class="blog-tags">
            ...
            <div class="program-sidebar">
              ...
              <div class="program-event">
                <div class="program-event-content">
                  ...
                  <a href="#" class="rts-theme-btn with-arrow btn-white lh-100">Joint Now <span><i
