    ...
    return (function (t) {
        ...
        function (t, e, n) {
            ...
            function j(t, e) {
                ...
                return U(t)
                    ? pt.duration(t * e)
                    : ((n = t.asMonths()), Math.abs(n) >= 1 && ut(n) ? pt.duration({ months: n * e }) : pt.duration({ days: t.asDays() * e }));
            }
            function U(t) {
                    ...
                    return (
                        ...
                        (t.prototype.intersect = function (e) {
                            ...
                            return (
                                ...
                                (null == n || null == r || n < r) &&
                                    ((i = new t(n, r)), (i.isStart = this.isStart && n === this.startMs), (i.isEnd = this.isEnd && r === this.endMs)),
                                i
                            );
                        }),
                    ...
                    return (
                        ...
                        (e.prototype.lockOverflow = function (t) {
                            ...
                            ((t = t || this.getScrollbarWidths()),
                                'auto' === e &&
                                    (e = t.top || t.bottom || this.scrollEl[0].scrollWidth - 1 > this.scrollEl[0].clientWidth ? 'scroll' : 'hidden'),
                                'auto' === n &&
                                    (n =
                                        t.left || t.right || this.scrollEl[0].scrollHeight - 1 > this.scrollEl[0].clientHeight ? 'scroll' : 'hidden'),
                    ...
                    return (
                        ...
                        (e.prototype.bindGlobalHandlers = function () {
                            (t.prototype.bindGlobalHandlers.call(this),
                                this.listenTo(d.default.get(), { touchstart: this.processUnselect, mousedown: this.handleDocumentMousedown }));
                        }),
                        (e.prototype.unbindGlobalHandlers = function () {
                    ...
                    return (
                        ...
                        (t.prototype._getTimeText = function (t, e, n, r, i) {
                            return (
                                ...
                                this.displayEventTime && !n ? (i && e ? this.view.formatRange({ start: t, end: e }, !1, r) : t.format(r)) : ''
                            );
                        }),
        ...
        function (t, e, n) {
            ...
            function p(t) {
                ...
                for (e = 0; e < t.length; e++)
                    ((n = t[e]),
                        n.token ? ((r = S[n.token.charAt(0)]), i.push(r ? r.unit : 'second')) : n.maybe ? i.push.apply(i, p(n.maybe)) : i.push(null));
                return i;
            }
            function h(t, e) {
                return g(f(t, e).join(''));
                            ...
                            for (e = 0; e < this.rowCnt; e++)
                                for (n = e * a, r = n + a - 1, i = n; i <= r; i++)
                                    ((o = Math.max(u, i)),
                                        ...
                                        (s = Math.floor(s)),
                                        o <= s &&
                                            c.push({ row: e, firstRowDayIndex: o - n, lastRowDayIndex: s - n, isStart: o === u, isEnd: s === d }));
                            return c;
                        }),
                    ...
                    return (
                        ...
                        (e.prototype.limitRow = function (t, e) {
                            ...
                            if (e && e < b.segLevels.length) {
                                for (
                                    n = b.segLevels[e - 1], r = b.cellMatrix, o = b.tbodyEl.children().slice(e).addClass('fc-limited').get(), s = 0;
                                    s < n.length;
                                    s++
                                ) {
                    ...
                    return (
                        ...
                        (t.prototype.stop = function (t, e) {
                            ...
                            this.isFollowing &&
                                ...
                                this.stopListeningTo(r(document)),
                                t && i && !this.isHidden
                                    ? ((this.isAnimating = !0), this.el.animate({ top: this.top0, left: this.left0 }, { duration: i, complete: o }))
                                    : o());
                        }),
                        ...
                        (e.prototype.triggerBeforeEventSegsDestroyed = function (t) {
                            ...
                            this.hasPublicHandlers('eventDestroy') &&
                                t.forEach(function (t) {
                                    var n;
                                    t.el &&
                                        ((n = t.footprint.getEventLegacy()), e.publiclyTrigger('eventDestroy', { context: n, args: [n, t.el, e] }));
                                });
                        }),
                        ...
                        (t.prototype.moment = function () {
                            ...
                            return (
                                'local' === this.opt('timezone')
                                    ...
                                    : (n = 'UTC' === this.opt('timezone') ? y.default.utc.apply(null, t) : y.default.parseZone.apply(null, t)),
                            ...
                            (this.dragListener = new c.default(s, {
                                ...
                                hitOver: function (t) {
                                    ...
                                    (r
                                        ...
                                        i &&
                                            s.renderDrag(
                                                s.eventRangesToEventFootprints(e.sliceRenderRanges(s.dateProfile.renderUnzonedRange, a.calendar)),
                                            ));
                                },
                                hitOut: function () {
                                    i = null;
